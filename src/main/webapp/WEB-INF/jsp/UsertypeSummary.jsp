...
<script type="text/javascript">
	...
	<div class="intro-header">
		<h2 style="text-align: center">Usertype Summary</h2>
		<br> 
		<br>
		<div class="well" style="margin: 0 25% 0 25%;padding-top:3%;">
			<form class="form-horizontal" action="/fmsv1/saveUsertype" role="form" method="POST" onsubmit="return validate(this);">
						...
						%>
							<c:forEach items="${user}" var="user">
								<tr>
									...
									<td><a href="/fmsv1/EditUsertype?id=${user.id}">${user.name}</a></td>
									<td>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			//not required ...  use firefox's firebug instead;
				...
				window.location.href = "/fmsv1/DeleteUsertype?id="+ btn_val;
				});
			});
	     });
	</script>
