...
<script type="text/javascript">
	...
	<div class="intro-header">
		<h2 style="text-align: center">Edit Relationship</h2>
		<div class="well" style="margin: 0 35% 0 35%; width: auto;">
			<br> <br>
			<form class="form-horizontal"
				style="margin-top: 5%; margin-left: 3%;"
				action="/fmsv1/updateRelation/" method="POST" onsubmit="return validate(this);">
				<input type="hidden" id="id" name="id"
					value='<c:out value="${relation.id}"/>' /> <label
					class="col-sm-2 control-label" style="width: auto;">Relationship</label>
				<input type="text" class="form-control" id="name" name="name"
					value='<c:out value="${relation.name}"/>' style="width: auto;"
